...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        function ErrorPass() {
            alert("Contraseña debe tener 6 dígitos como mínimo.");
        }
    </script>
    <br /><br />
<center>
       ...
       <!--Instrucciones -->
     <asp:Panel runat="server" ID="plCalculo" Visible="false" style="margin-left:-10px">
    <div class="panel panel-default col-sm-3" style="margin-left:-10px">
