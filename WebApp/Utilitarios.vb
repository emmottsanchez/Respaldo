Module Utilitarios
    ...
    Function VarSQL(ByVal Valor As String, ByVal Tipo As TipoVar, Optional CeroNulo As Boolean = False, Optional EliminarComodinesSQL As Boolean = True) As String
        ...
        Select Case Tipo
            ...
            Case TipoVar.Fecha
                VarSQL = "'" & String.Format("{0:yyyMMdd}", CDate2(Valor)) & "'"
        ...
        Select Case Tipo
            ...
            Case TipoVar.Fecha
                ...
                ElseIf Not IsDate(Valor) Then
                    VarControl = ""
                Else
                    VarControl = IIf(Day(Valor) < 10, "0", "") & Day(Valor).ToString
                    VarControl += "-" & IIf(Month(Valor) < 10, "0", "") & Month(Valor).ToString
                    VarControl += "-" & Year(Valor)
                End If
