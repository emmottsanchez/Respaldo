<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Regional.aspx.vb" Inherits="WebApp.Regional" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
    <div class="TituloPrincipal">
        <table style="width:100%">
            <tr style="height:32px;">
                ...
                <td style="width:600px"><asp:Label ID="lblTitulo" runat="server" Text="Resumen Regional" Font-Size="18px"></asp:Label>&nbsp;&nbsp; </td>
    ...
    <asp:MultiView ID="multiview1" runat="server" ActiveViewIndex="0">  
        <asp:View ID="viewAcumulado" runat="server">
            ...
            <div style="overflow:auto;width:1320px;margin-left:-40px">
            <table class="TablaEncabezadoDatos" style="width:1480px;">
        <tr>
        ...
        <tr>
            <td style="width:300px">
                <asp:LinkButton ID="lbUsuarioAgente" runat="server" CommandArgument="UsuarioAgente" ToolTip="Ordenar">Agente</asp:LinkButton>
            </td>
            <td style="width:35px">
        ...
        <tr class="d0">
            ...
            <td>
                <asp:Label ID="lblMetaTrab" runat="server" />
            </td>
            <td>
                <asp:Label ID="lblMetaPropTrab" runat="server" />
            </td>
            <td>
                <asp:Label ID="lblSegTrab" runat="server" />
            </td>
            <td>
            ...
            <td></td>
            <td>
                <asp:Label ID="lblMetaPens" runat="server" />
            </td>
            <td>
                <asp:Label ID="lblMetaPropPens" runat="server" />
            </td>
             <td>
                <asp:Label ID="lblSegPens" runat="server" />
            </td>
            <td>
            ...
            <td></td>
            <td>
                <asp:Label ID="lblMetaCes" runat="server" />
            </td>
            <td>
                <asp:Label ID="lblMetaPropCes" runat="server" />
            </td>
             <td>
                <asp:Label ID="lblSegCes" runat="server" />
            </td>
            <td>
         ...
         <div style="overflow:auto;height:300px;width:1510px;">
           <div class="TablaDatos" style="width:1480px" >
        <asp:GridView ID="gv1" runat="server" AutoGenerateColumns = "False" 
            ...
            <Columns>
                ...
                <asp:TemplateField >                 
                    ...
                    <ItemTemplate> 
                        <asp:LinkButton runat="server" 
                                        ...
                                        Text='<%# Bind("UsuarioAgente")%>' 
                                        CommandName = "VerAgente"
                                        CommandArgument='<%# Bind("IdUsuarioAgente")%>'
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegTrabMeta" runat="server" Text='<%# Bind("MetaTrab", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                 ...
                 <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegTrabM" runat="server" Text='<%# Bind("MetaPropTrab", "{0:N2}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegPensMeta" runat="server" Text='<%# Bind("MetaPens", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegTrabP" runat="server" Text='<%# Bind("MetaPropPens", "{0:N2}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                  ...
                  <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegPen" runat="server" Text='<%# Bind("SegurosPens", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegCesMeta" runat="server" Text='<%# Bind("MetaCes", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblSegTrabC" runat="server" Text='<%# Bind("MetaPropCes", "{0:N2}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
        ...
        <asp:View ID="viewUltimoDiaHabil" runat="server">
            ...
            <table class="TablaEncabezadoDatos" style="width:1030px">
        <tr>
            ...
            <td style="width:50px">
                &nbsp;</td>
            <td colspan="5">
                Crédito Pensionado</td>
            <td style="width:50px"></td>
            <td colspan="2">
                Crédito Trabajador</td>
        </tr>
        <tr>
            <td style="width:310px">
                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument="UsuarioAgente" ToolTip="Ordenar">Agente</asp:LinkButton>
            </td>
            <td style="width:50px">
                &nbsp;</td>
            <td style="width:50px">
    ...
    <div class="TablaDatos" style="overflow:auto;height:300px;width:1490px" >
        <asp:GridView ID="gv2" runat="server" AutoGenerateColumns = "False" 
            ...
            <Columns>
                ...
                <asp:TemplateField >                 
                    ...
                    <ItemTemplate> 
                        <asp:label runat="server" ID="lblUsuarioRegional" Text='<%# Bind("UsuarioAgente")%>' CssClass="lblEstandar"  />
                    </ItemTemplate>   
                </asp:TemplateField> 
