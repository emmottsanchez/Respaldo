<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Red.aspx.vb" Inherits="WebApp.Red" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
    ...
    <div class="TituloPrincipal">
        <table style="width:100%">
            <tr style="height:32px;">
                ...
                <td style="width:300px"><asp:Label ID="lblTitulo" runat="server" Text="Resumen Red Comercial" Font-Size="18px"></asp:Label>&nbsp;&nbsp; </td>
    ...
    <asp:MultiView ID="multiview1" runat="server" ActiveViewIndex="0">  
        ...
        <div style="width:1320px; overflow:auto;margin-left:-35px">
            <table class="TablaEncabezadoDatos" style="width:1620px;">
                <tr>
                ...
                <tr>
                    <td style="width:190px">
                        <asp:LinkButton ID="lbUsuarioRegional" runat="server" CommandArgument="UsuarioRegional" ToolTip="Ordenar">Regional</asp:LinkButton>
                    </td>
                    <td style="width:35px">
                    ...
                    <td style="width:10px">&nbsp;</td>
                    <td style="width:35px">
                     <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument="Trab" ToolTip="Ordenar">Meta Mes</asp:LinkButton>
            </td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton8" runat="server" CommandArgument="Trab2" ToolTip="Ordenar">Meta Prop.</asp:LinkButton>
            </td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton10" runat="server" CommandArgument="Trab3" ToolTip="Ordenar">Cant.</asp:LinkButton>
            </td>
            <td style="width:40px">
                <asp:LinkButton ID="LinkButton15" runat="server" CommandArgument="Trab4" ToolTip="Ordenar">% Cumpl. Prop.</asp:LinkButton>
            </td>
            <td style="width:10px">&nbsp;</td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton16" runat="server" CommandArgument="Pens" ToolTip="Ordenar">Meta Mes</asp:LinkButton>
            </td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton17" runat="server" CommandArgument="Pens2" ToolTip="Ordenar">Meta Prop.</asp:LinkButton>
            </td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton18" runat="server" CommandArgument="Pens3" ToolTip="Ordenar">Cant.</asp:LinkButton>
            </td>
            <td style="width:40px">
                <asp:LinkButton ID="LinkButton19" runat="server" CommandArgument="Pens4" ToolTip="Ordenar">% Cumpl. Prop.</asp:LinkButton>
            </td>
            <td style="width:10px">&nbsp;</td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton20" runat="server" CommandArgument="Ces" ToolTip="Ordenar">Meta Mes</asp:LinkButton>
            </td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton21" runat="server" CommandArgument="Ces2" ToolTip="Ordenar">Meta Prop.</asp:LinkButton>
            </td>
            <td style="width:35px">
                <asp:LinkButton ID="LinkButton22" runat="server" CommandArgument="Ces3" ToolTip="Ordenar">Cant.</asp:LinkButton>
            </td>
            <td style="width:40px">
                <asp:LinkButton ID="LinkButton23" runat="server" CommandArgument="Ces4" ToolTip="Ordenar">% Cumpl. Prop.</asp:LinkButton>
            </td>
                </tr >
                <tr class="d0">
                    <td>
            ...
            <div class="TablaDatos" style="width:1620px" >
        <asp:GridView ID="gv1" runat="server" AutoGenerateColumns = "False" 
            ...
            <Columns>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaCredTraMto" runat="server" Text='<%# Bind("MetaCredTraMto", "{0:N1}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaPropCredTraMto" runat="server" Text='<%# Bind("MetaPropCredTraMto", "{0:N1}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="55px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCumCredTraMto" runat="server" Text='<%# Bind("CumCredTraMto", "{0:P0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaTrab" runat="server" Text='<%# Bind("MetaTrab", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaPTrab" runat="server" Text='<%# Bind("MetaPropTrab", "{0:N2}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="55px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCumpTrab" runat="server" Text='<%# Bind("CumpTrab", "{0:P0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaPens" runat="server" Text='<%# Bind("MetaPens", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaPPens" runat="server" Text='<%# Bind("MetaPropPens", "{0:N2}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="55px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCumpPens" runat="server" Text='<%# Bind("CumpPens", "{0:P0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaCes" runat="server" Text='<%# Bind("MetaCes", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="40px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblMetaPCes" runat="server" Text='<%# Bind("MetaPropCes", "{0:N2}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="55px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCumpCes" runat="server" Text='<%# Bind("CumpCes", "{0:P0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
            </Columns>
        ...
        <asp:View ID="viewUltimoDiaHabil" runat="server">
            ...
            <table class="TablaEncabezadoDatos" style="width:960px">
                <tr>
                ...
                <tr>
                    <td style="width:310px">
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument="UsuarioRegional" ToolTip="Ordenar">Regional</asp:LinkButton>
                    </td>
                    <td style="width:50px">
                        &nbsp;</td>
                    <td style="width:50px">
            ...
            <div class="TablaDatos" style="width:1250px">
        ...
        <asp:GridView ID="gv2" runat="server" AutoGenerateColumns = "False" 
            ...
            <Columns>
                ...
                <asp:TemplateField >                 
                    ...
                    <ItemTemplate> 
                        <asp:label runat="server" ID="lblUsuarioRegional" Text='<%# Bind("UsuarioRegional")%>' CssClass="lblEstandar" />
                    </ItemTemplate>   
                </asp:TemplateField> 
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="45px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblAfiliacionesUDH" runat="server" Text='<%# Bind("AfiliacionesUDH", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="45px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCredPenCantUDH" runat="server" Text='<%# Bind("CredPenCantUDH", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="45px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCredPenMtoUDH" runat="server" Text='<%# Bind("CredPenMtoUDH", "{0:N1}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="45px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCredTraCantUDH" runat="server" Text='<%# Bind("CredTraCantUDH", "{0:N0}")%>' ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
                ...
                <asp:TemplateField >                 
                    <ItemStyle Width="45px" HorizontalAlign="Center"/>
                    <ItemTemplate> 
                        <asp:Label ID="lblCredTraMtoUDH" runat="server" Text='<%# Bind("CredTraMtoUDH", "{0:N1}")%>'  ></asp:Label> 
                    </ItemTemplate>   
                </asp:TemplateField>
            </Columns>
