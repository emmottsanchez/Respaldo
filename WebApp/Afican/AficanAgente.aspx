<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AficanAgente.aspx.vb" Inherits="WebApp.AficanAgente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
    ...
    <Table class="Totalestabla" border="1">
        <Tr>
            <td width="287px" bgcolor="#0e4438" ><asp:Label ID="Label1" runat="server" Text="Agentes" ForeColor="White" Font-Size="12px"></asp:Label></td>
    ...
    <Table class="Totalestabla" border="1">
        <Tr>
            <td width="285px"><asp:Label ID="lblTotales" runat="server" Text="Totales" Font-Size="13px"></asp:Label></td>
    ...
    <asp:GridView runat="server" ID="gv1" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" ShowHeader="false" CssClass="Grid1">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Agentes">                 
                <ItemStyle Width="280px" HorizontalAlign="Left"  Font-Size="13px"/>
                <ItemTemplate> 
                    <asp:LinkButton runat="server" 
                                    ...
                                    ToolTip="Ver Sucursales a cargo"
                                    ForeColor="#003366"
                                     />
                </ItemTemplate>   
            </asp:TemplateField> 
