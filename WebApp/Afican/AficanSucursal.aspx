<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AficanSucursal.aspx.vb" Inherits="WebApp.AficanSucursal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
    ...
    <table class="Totalestabla" border="1">
        <tr>
            <td width="220px" bgcolor="#0e4438" ><asp:Label ID="Label1" runat="server" Text="Sucursales" ForeColor="White" Font-Size="12px"></asp:Label></td>
    ...
    <table class="Totalestabla" border="1">
        <tr>
            <td width="220px"><asp:Label ID="lblTotales" runat="server" Text="Totales" Font-Size="13px"></asp:Label></td>
      ...
      <asp:GridView runat="server" ID="gv1" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" ShowHeader="false" CssClass="Grid1">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Sucursales" >                 
                <ItemStyle Width="220px" HorizontalAlign="Left" Font-Size="13px"/>
                <ItemTemplate> 
                    <asp:LinkButton runat="server" 
                                    ID="lbSucursal" 
                                    Text='<%# Bind("[SUCURSAL BT]")%>' 
                                    CommandName = "VerSucursal"
                                    CommandArgument='<%# Bind("CodSucursal")%>'
                                    ToolTip="Ver Sucursale" 
                                    ForeColor="#003366"
                                    />
                </ItemTemplate>   
            </asp:TemplateField> 
            ...
            <asp:BoundField DataField="PrcPropCumRed" HeaderText="% Cump Prop" DataFormatString="{0:P1}" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
            ...
            <asp:BoundField DataField="PrcPropCumIn" HeaderText="% Cump Prop" DataFormatString="{0:P1}" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
            ...
            <asp:BoundField DataField="PrcPropCumOut" HeaderText="% Cump Prop" DataFormatString="{0:P1}" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
            ...
            <asp:BoundField DataField="PrcPropCumBen" HeaderText="% Cump Prop" DataFormatString="{0:P1}" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
            ...
            <asp:BoundField DataField="PrcPropCumFfaa" HeaderText="% Cump Prop" DataFormatString="{0:P1}" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>

            <asp:BoundField DataField="MetaTotal" HeaderText="Meta FFAA" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="TotalAfi" HeaderText="Afiliaciones FFAA" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
            <asp:BoundField DataField="CumpPropTotal" HeaderText="% Cump Prop" DataFormatString="{0:P1}" >
                  <ItemStyle Width="70px" Font-Size="13px"></ItemStyle>
            </asp:BoundField>
        </Columns>
